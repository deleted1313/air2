...
<a href="#"><i class="fa  fa-vk" aria-hidden="true" style="    margin-top: 345px;
    padding-left: 5px;
    font-size: 24px;
    padding-bottom: 20px; color:#95969a;"></i></a>
<a href="#"><i class="fa  fa-facebook" aria-hidden="true" style="padding-left: 11px;
    font-size: 24px;
    padding-bottom: 20px; color:#95969a;"></i></a>
<a href="#"><i class="fa  fa-youtube" aria-hidden="true" style="padding-left: 9px;
    font-size: 24px;
...
<p class="its_2">Помимо этого, мы занимаемяс поставками сопутствующего оборудования и методических пособий по робототехнике.</p>
 <p class="its_2">Но самое главное, Агентство инновационного развития имеет опыт комплексных решений: создание лабораторий, «кружков» робототехники «под ключ». Мы не только подберем оптимальное оборудование для Вас, но и проведем необходимую настройку и обучение, укомплектуем необходимым методическим материалом! </p>
                ...
                <div class="col offset-l1 l6 m12 s12" style="padding-right: 0;">
                    <div class="back_it_start">
                      ...
                      <p class="s_liniey" style="padding-top: 14px;">Робототехника сегодя занимает лидирующие <br>
